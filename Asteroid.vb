Public Class Asteroid
    ...
    Public Sub Show(G As Graphics)
        If visible Then
            ...
            Select Case type
                Case 0
                    points = {New Point(x + 31, y + 2), New Point(x + 8, y + 4), New Point(x + 3, y + 28), New Point(x + 11, y + 45), New Point(x + 32, y + 62), New Point(x + 49, y + 50), New Point(x + 61, y + 29), New Point(x + 45, y + 9)}
                Case 1
                ...
                Case 3
                    points = {New Point(x + 31, y + 1), New Point(x + 8, y + 5), New Point(x + 1, y + 31), New Point(x + 12, y + 49), New Point(x + 31, y + 61), New Point(x + 47, y + 47), New Point(x + 59, y + 31), New Point(x + 42, y + 8)}
            End Select
